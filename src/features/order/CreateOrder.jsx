...
import { clearCart, getCartTotal } from '../cart/cartSlice';
...
function CreateOrder() {
  ...
  const priorityPrice = withPriority ? Math.floor(totalPrice * 0.2) : 0;
      ...
      <Form method="POST">
        ...
        <div>
          ...
          <Button disabled={isSubmitting || isAddressLoading} type="primary">
            {isSubmitting ? 'Placing order....' : `Order now from $${total}`}
          </Button>
        </div>
      </Form>
    </div>
